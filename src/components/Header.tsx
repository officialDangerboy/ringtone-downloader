...
const Header = ({ onSearch, onLogoClick }: HeaderProps) => {
      ...
      <div className="max-w-screen-2xl mx-auto px-4 py-3 md:py-4">
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <form
            ...
            className="flex md:hidden items-center max-w-xs gap-2"
          >
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10 pr-4 h-10 glass-card border-border/50 focus:border-primary"
              />
            </div>
            <Button type="submit" className="h-10 px-4 bg-primary text-primary-foreground hover:bg-primary/90">
              Search
            </Button>
          </form>
          ...
          <form
            onSubmit={handleSubmit}
            className="hidden md:flex flex-1 max-w-2xl gap-2 items-center"
          >
            <div className="relative flex-1">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
              <Input
          ...
          <nav className="hidden lg:flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" onClick={() => scrollToSection("stats")}>
              Statistics
            </Button>
          </nav>
